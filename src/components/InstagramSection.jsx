  ...
  return (
    ...
    >
      ...
      <div className="scene-layout" style={{ position: 'sticky', top: 0 }}>
        <div className="container" style={{ textAlign: 'center', marginBottom: 'clamp(1rem, 4vh, 3rem)', zIndex: 10 }}>
        ...
        <div style={{ width: '100vw', overflow: 'hidden', marginBottom: 'clamp(1rem, 3vh, 2rem)' }}>
          <motion.div style={{ x, display: 'flex', gap: '4vw', padding: '0 4vw', height: isDesktop ? '50vh' : '40vh', width: 'max-content' }}>
            {instaPosts.map((src, idx) => (
              <motion.a
                href="https://instagram.com/academiayanesgallardo1"
                target="_blank"
              ...
              >
                <img src={src} style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} alt={`Instagram post ${idx + 1}`} loading="lazy" />
              </motion.a>
            ))}
          </motion.div>
        </div>
